...
| `.lk-iv-big-play`, `.lk-iv-spinner`, `.lk-iv-error`, `.lk-iv-caption[data-size][data-background]` | The centre play button, the buffering ring, the failure message, and the drawn captions |
