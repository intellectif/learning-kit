...
- [#98](https://github.com/intellectif/learning-kit/pull/98) [`e2b3100`](https://github.com/intellectif/learning-kit/commit/e2b310024f25b7d7e38054f833e324b2978ef7ac) Thanks [@diego28e](https://github.com/diego28e)! - **Components declare their return type**: every component's declaration now reads `React.JSX.Element`. The type is unchanged; only its spelling in the `.d.ts` files is.
...
- [#90](https://github.com/intellectif/learning-kit/pull/90) [`9b5f5ef`](https://github.com/intellectif/learning-kit/commit/9b5f5ef6243f825c1336628d38816789993455b3) Thanks [@diego28e](https://github.com/diego28e)! - **Multiple choice under `feedback: false`**: no longer says "Answer submitted." before the learner has answered.
...
- [#86](https://github.com/intellectif/learning-kit/pull/86) [`2215060`](https://github.com/intellectif/learning-kit/commit/22150600b0d8f5f058214a0551566b58e154276d) Thanks [@diego28e](https://github.com/diego28e)! - **Coaching on a reading aloud**: "Coach me on this reading" under a read-aloud's marks, where a model may coach only the words the speech engine marked.
...
- [#84](https://github.com/intellectif/learning-kit/pull/84) [`c037af8`](https://github.com/intellectif/learning-kit/commit/c037af83d73ec095e24853794cb299149bd7964f) Thanks [@diego28e](https://github.com/diego28e)! - **AI help spans the answer**: the "Explain my answer" panel and the list of hints now take the full width of the question, as feedback on a draft already did.
...
- [#82](https://github.com/intellectif/learning-kit/pull/82) [`bcae525`](https://github.com/intellectif/learning-kit/commit/bcae52599d7d0481ccd8ceecdfc59f2bd6d4d281) Thanks [@diego28e](https://github.com/diego28e)! - **1.0**: what every 1.x keeps stable, written down, and from now on a lk-core minor releases no lk-react. No grade changes.
...
- Updated dependencies [[`bcae525`](https://github.com/intellectif/learning-kit/commit/bcae52599d7d0481ccd8ceecdfc59f2bd6d4d281)]:
  - @intellectif/lk-core@1.0.0

## 22.0.0

### Major Changes

- [#80](https://github.com/intellectif/learning-kit/pull/80) [`782b01b`](https://github.com/intellectif/learning-kit/commit/782b01ba697a90583b472ab1a7a2be102fd888c4) Thanks [@diego28e](https://github.com/diego28e)! - **Feedback on writing**: "Get feedback on my draft" on a written response in practice. The learner revises and asks again, and every correction must quote what they wrote.
...
- Updated dependencies [[`782b01b`](https://github.com/intellectif/learning-kit/commit/782b01ba697a90583b472ab1a7a2be102fd888c4)]:
  - @intellectif/lk-core@0.22.0

## 21.0.0

### Major Changes

- [#78](https://github.com/intellectif/learning-kit/pull/78) [`30a9b3d`](https://github.com/intellectif/learning-kit/commit/30a9b3da9be60589d63516752a02cc2f44bdf73b) Thanks [@diego28e](https://github.com/diego28e)! - **Scoring policies**: "Try again" in practice, which try counts, and what tries and hints cost — set per paper, recorded in the plan, and no grade moves without one.
...
- Updated dependencies [[`30a9b3d`](https://github.com/intellectif/learning-kit/commit/30a9b3da9be60589d63516752a02cc2f44bdf73b)]:
  - @intellectif/lk-core@0.21.0

## 20.0.0

### Major Changes

- 73a37e3: Every activity, `<ActivitySequence>` and `<InteractiveVideo>` take a `delivery` policy: what the school
...
- d576382: AI help now reports what it cost and what was refused.
...
- Updated dependencies [d576382]
  - @intellectif/lk-core@0.19.0

## 18.1.0

### Minor Changes

- 50c3285: A question a host draws inside `<ActivitySequence>` gets everything one the SDK draws has, and the AI
  ...
  assigning an `ActivityRenderer` _back_ to a `ComponentType<ActivityProps>` variable needs a widened
  annotation.
...
- 15a3435: Learners can ask an AI for help. "Explain my answer" appears under a graded answer, and "Get a hint"
...
- 15a3435: `<WrittenResponse>` gives every inline correction in a returned grade a list key of its own. A grade
...
- Updated dependencies [15a3435]
  - @intellectif/lk-core@0.17.0

## 16.1.1

### Patch Changes

- 287c896: Documentation: `<InteractiveVideo>` is a formative tool, for lessons and practice — not for official
  summative exams, which `<ActivitySequence>` delivers. The learner controls the recording while the
  questions are open (rewinds it, slows it, reads its transcript), a quiz can be reopened, and nothing
  in the player times a question or holds a single pass. Its `exam` mode is a check-in without
  feedback, not exam conditions; its questions still grade exactly as they do anywhere else.

  The component's and `renderMode`'s documentation say so now, as do the README and the interactive
  video guide. No behaviour changes.

## 16.1.0

### Minor Changes

- 814365c: `<InteractiveVideo>` lets a host draw its questions itself: **`renderQuestion(question)`**, called
...
- 7992fac: `<InteractiveVideo>` shows two caption languages at once: a first line and, when the learner asks for
...
- Updated dependencies [7992fac]
  - @intellectif/lk-core@0.16.0

## 15.0.0

### Major Changes

- 5a80ea8: `<InteractiveVideo>`: a video that stops at each quiz, asks its questions over itself and carries on.
...
- Updated dependencies [5a80ea8]
  - @intellectif/lk-core@0.15.0

## 14.1.0

### Minor Changes

- ecc47e0: Play-budget and read-aloud fixes, and a way to record under a strict Content-Security-Policy.
...
- Updated dependencies [ecc47e0]
  - @intellectif/lk-core@0.14.1
...
- dddb355: `<ActivitySequence>`'s missing-`shuffleSeed` error now names every shuffle that raises it.
...
- Updated dependencies [ea2d620]
  - @intellectif/lk-core@0.10.1
...
- Updated dependencies [a88b3f9]
  - @intellectif/lk-core@0.10.0
