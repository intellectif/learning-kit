 ...
 * Palette is a neutral monochrome, deliberately unbranded, so the SDK carries
 * nobody's look out of the box; consumers rebrand via `ThemeProvider`. All
 * colour pairs are verified to meet WCAG 2.2 AA: 4.5:1 for normal text, 3:1 for
 * UI / focus ring (see theme/__tests__/contrast.test.ts).
 */
